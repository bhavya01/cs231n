...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        a3, a3_cache = affine_forward(a2, W3, b3)
        scores = a3
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        dx3, dw3, db3 = affine_backward(dout, a3_cache)
        dx2, dw2, db2 = affine_relu_backward(dx3, a2_cache)
        dx1, dw1, db1 = conv_relu_pool_backward(dx2, a1_cache)
